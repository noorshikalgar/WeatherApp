...
var AppComponent = (function () {
    ...
    AppComponent.prototype.getWeather = function () {
        this.bool = true;
        return this.http.get(this.base_url + this.query + '&units=metric').map(function (res) { return res.json(); });
    };
    AppComponent.prototype.postWeather = function () {
        var _this = this;
        this.getWeather().subscribe(function (data) {
            _this.object = data;
        });
    };
    return AppComponent;
